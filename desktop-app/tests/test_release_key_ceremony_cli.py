...
class LauncherTests(unittest.TestCase):
    ...
    def test_14_mismatched_password_rejected(self):self.assertRaises(CeremonyLauncherError,run_attended_launcher,self.cfg,self.deps(secrets=["synthetic password 001","different password 002"]))
    def test_15_short_password_rejected(self):self.assertRaises(CeremonyLauncherError,run_attended_launcher,self.cfg,self.deps(secrets=["short","short"]))
