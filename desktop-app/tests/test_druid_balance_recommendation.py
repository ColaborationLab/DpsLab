...
def export_text_three_loadouts():
    value = {"schema_version": "0.5", "observation_type": "live_manual_analysis_export", "compatibility": {"wow_product": "retail", "build": 69587, "interface_version": 120100}, "subject": {"class_id": 11, "specialization_id": 102, "role": "damage", "level": 90, "race_id": 4}, "analysis_context": {"talent_loadouts": [{"config_id": 1, "talent_string": "ABCD"}, {"config_id": 2, "talent_string": "EFGH"}, {"config_id": 3, "talent_string": "IJKL"}]}, "equipment": {"equipped": [{"item_id": 100, "item_level": 250, "item_link": "item:100", "location": 1, "slot": "slot_1", "source": "equipped"}]}, "safety": {"contains_direct_identifiers": False, "executable": False, "no_automation": True}}
    return PREFIX + canonical_live_analysis_bytes(value).decode()
