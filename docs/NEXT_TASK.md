...
## Published design record — Desktop interface architecture 0.1
...
The design remains local-only and non-executable. GitHub Actions run #118
approved policy and contract, static analysis and secret scanning, tools tests,
...
{
  "contract_version":"0.1",
  "task_id":"desktop_framework_selection_0_1_design",
  "title":"Select a framework-neutral implementation direction for the local Windows desktop interface",
  "baseline_commit":"fe263149b424ce9da9d6bd14bc543b86f39ca187",
  "authorization":{"status":"design_only","authorization_id":"desktop_framework_selection_0_1_design-20260828-daniel-broad-authority","authorized_by":"Daniel","authorized_at":"2026-08-28T23:55:00-05:00"},
  "scope":{"allowed_paths":["docs/DESKTOP_FRAMEWORK_SELECTION.md","docs/NEXT_TASK.md"],"generated_paths":[".dpslab/quality-gates/desktop_framework_selection_0_1_design/design.json"],"forbidden_paths":[".github/**","desktop-app/**","security/**","tools/**","knowledge/**","profiles/**","scenarios/**","variants/**","comparisons/**","results/**","config/**","flasil.simc","AGENTS.md","SECURITY.md","docs/ROADMAP.md","docs/PROJECT_BRIEF.md"],"allow_deletions":false,"allow_renames":false},
  "tests":{"focused":{"working_directory":".","argv":["python","-m","unittest","discover","-s","tools/tests","-v"],"environment":{"PYTHONDONTWRITEBYTECODE":"1"}},"full":{"working_directory":".","argv":["python","-m","unittest","discover","-s","tools/tests","-v"],"environment":{"PYTHONDONTWRITEBYTECODE":"1"}},"baseline_test_count":87,"minimum_test_count":87},
  "protected_files":{"AGENTS.md":"1886e30bdec4abf3669dee0c2f0ce0a7271fa3cf30ed3830dfff24aef49edcb0","SECURITY.md":"b00e680630009bfd062a58b5a8d3129b9c68e45fb8aa284f05133f173fe2daf5","security/security_baseline_0_1.json":"a052db44ed119988fe5e40d244cd08e0f346ffcbe2dc1a7098488af88be88b6b"},
  "audit":{"required":true,"independence":"declared_and_procedural"},
...
{
  "contract_version":"0.1",
  "task_id":"addon_synthetic_exchange_envelope_0_1",
  "title":"Implement and validate a closed synthetic local exchange envelope for the future desktop-addon boundary",
  "baseline_commit":"64a846ff9203f737e41d29bb4be4f420699d7e3a",
  "authorization":{"status":"authorized_for_implementation","authorization_id":"addon_synthetic_exchange_envelope_0_1-20260829-daniel-broad-authority","authorized_by":"Daniel","authorized_at":"2026-08-29T11:20:00-05:00"},
  "scope":{"allowed_paths":["addon/DpsLab/DpsLab.toc","addon/DpsLab/SyntheticExchange.lua","tools/tests/test_addon_synthetic_exchange.py","tools/tests/test_addon_synthetic_guidance.py","docs/NEXT_TASK.md"],"generated_paths":[".dpslab/quality-gates/addon_synthetic_exchange_envelope_0_1/implementation.json",".dpslab/quality-gates/addon_synthetic_exchange_envelope_0_1/audit.json"],"forbidden_paths":[".github/**","desktop-app/**","security/**","knowledge/**","profiles/**","scenarios/**","variants/**","comparisons/**","results/**","config/**","flasil.simc","AGENTS.md","SECURITY.md","LICENSE","LICENSE.*","NOTICE","NOTICE.*","TRADEMARK*"],"allow_deletions":false,"allow_renames":false},
  "tests":{"focused":{"working_directory":".","argv":["python","-m","unittest","discover","-s","tools/tests","-v"],"environment":{"PYTHONDONTWRITEBYTECODE":"1"}},"full":{"working_directory":".","argv":["python","-m","unittest","discover","-s","tools/tests","-v"],"environment":{"PYTHONDONTWRITEBYTECODE":"1"}},"baseline_test_count":87,"minimum_test_count":87},
  "protected_files":{"AGENTS.md":"1886e30bdec4abf3669dee0c2f0ce0a7271fa3cf30ed3830dfff24aef49edcb0","SECURITY.md":"b00e680630009bfd062a58b5a8d3129b9c68e45fb8aa284f05133f173fe2daf5","desktop-app/requirements-ci-win-py313.lock":"8d2dfca84345d1c17ef575d50d01eaa36d5cea6fd94c25fc531e7180979e3586","security/sbom-runtime-win-py313.spdx.json":"0f92571035f4db9263cc2709dc4187f4f70db73b5f4e34e0fa826ded672c648c","addon/DpsLab/DpsLab.lua":"204a4d0013cdf4df3c3865b4938fa5a79114a24bab8527389dfed4fa7b617ca3","addon/DpsLab/SyntheticGuidance.lua":"c4a198aa134978b9d88e6e7f908115bee0237a80ceb4bc4cad6356ad37a47b27"},
  "audit":{"required":true,"independence":"declared_and_procedural"},
...
## Published implementation record — Local Retail selection store 0.1
...
The bounded local selection store was published through
`12b8f248a936c5d0c96f5add0df24d7e74422213`. GitHub Actions run #154
...
{
  "contract_version":"0.1",
  "task_id":"addon_observation_import_coordinator_0_1",
  "title":"Coordinate an explicit sanitized addon observation import from the local Retail selection",
  "baseline_commit":"12b8f248a936c5d0c96f5add0df24d7e74422213",
  "authorization":{"status":"authorized_for_implementation","authorization_id":"addon_observation_import_coordinator_0_1-20260830-daniel-expanded-continuation","authorized_by":"Daniel","authorized_at":"2026-08-30T01:54:40-05:00"},
  "scope":{"allowed_paths":["desktop-app/src/dpslab/addon_observation_import.py","desktop-app/tests/test_addon_observation_import.py","docs/ADDON_OBSERVATION_TRANSPORT.md","docs/NEXT_TASK.md"],"generated_paths":[".dpslab/quality-gates/addon_observation_import_coordinator_0_1/implementation.json",".dpslab/quality-gates/addon_observation_import_coordinator_0_1/audit.json"],"forbidden_paths":[".github/**","addon/**","security/**","tools/**","knowledge/**","profiles/**","scenarios/**","variants/**","comparisons/**","results/**","config/**","flasil.simc","AGENTS.md","SECURITY.md","LICENSE","LICENSE.*","NOTICE","NOTICE.*","TRADEMARK*"],"allow_deletions":false,"allow_renames":false},
  "tests":{"focused":{"working_directory":"desktop-app","argv":["python","-m","unittest","tests.test_addon_observation_import","-v"],"environment":{"PYTHONPATH":"src","PYTHONDONTWRITEBYTECODE":"1"}},"full":{"working_directory":"desktop-app","argv":["python","-m","unittest","tests.test_addon_observation_import","tests.test_retail_installation_store","tests.test_retail_installation","-v"],"environment":{"PYTHONPATH":"src","PYTHONDONTWRITEBYTECODE":"1"}},"baseline_test_count":19,"minimum_test_count":29},
  "protected_files":{".github/workflows/dpslab-ci.yml":"17677d962db150a8ecbe043da31d353428fe85afc00bc4e46cc60a2719b88348","AGENTS.md":"1886e30bdec4abf3669dee0c2f0ce0a7271fa3cf30ed3830dfff24aef49edcb0","SECURITY.md":"b00e680630009bfd062a58b5a8d3129b9c68e45fb8aa284f05133f173fe2daf5","security/security_baseline_0_1.json":"a052db44ed119988fe5e40d244cd08e0f346ffcbe2dc1a7098488af88be88b6b","desktop-app/src/dpslab/retail_installation_store.py":"07e988802b73ea2ae35446ca134d6fedb4bb2f31eac100ee629cd5d0b624a5c7","desktop-app/src/dpslab/retail_installation.py":"56dfb18b72bd00287d75f385355a20511c12604d73bbb008cd514f779561adc1","desktop-app/src/dpslab/addon_observation_acquisition.py":"a23d272d0b50e0ea6a5509687be25d60817c040091bebcab140cae836dfe41af","desktop-app/src/dpslab/addon_observation_transport.py":"1b714689efc721ff50e0f2d69db918c23ae46c05ea77ea62204c85c2144432d5","desktop-app/src/dpslab/wow_process_state.py":"826bbb1c691b7602b07047caaeb2a3da268fb374b0b3c12e3730962d242ded6a"},
  "audit":{"required":true,"independence":"declared_and_procedural"},
...
## Published implementation record — Druid identity-context binding 0.1
...
The identity-context binding was implemented, tested, procedurally audited,
committed and published through
`f30e529b2994edab746459ae9b44abab12d377b3`. Focused tests passed 8/8,
the functional suite passed 1216/1216 with one expected skip, and the tools
suite passed 133/133. GitHub Actions run #163 approved Policy and contract,
...
{
  "contract_version":"0.1",
  "task_id":"druid_synthetic_guidance_coordination_0_1",
  "title":"Coordinate validated Druid identity and role context with governed synthetic catalog guidance",
  "baseline_commit":"f30e529b2994edab746459ae9b44abab12d377b3",
  "authorization":{"status":"authorized_for_implementation","authorization_id":"druid_synthetic_guidance_coordination_0_1-20260830-daniel-continue","authorized_by":"Daniel","authorized_at":"2026-08-30T13:20:00-05:00"},
  "scope":{"allowed_paths":["desktop-app/src/dpslab/druid_guidance_coordinator.py","desktop-app/tests/test_druid_guidance_coordinator.py","docs/DRUID_VERTICAL_SLICE.md","docs/NEXT_TASK.md"],"generated_paths":[".dpslab/quality-gates/druid_synthetic_guidance_coordination_0_1/implementation.json",".dpslab/quality-gates/druid_synthetic_guidance_coordination_0_1/audit.json"],"forbidden_paths":[".github/**","addon/**","security/**","tools/**","knowledge/**","profiles/**","scenarios/**","variants/**","comparisons/**","results/**","config/**","flasil.simc","AGENTS.md","SECURITY.md","LICENSE","LICENSE.*","NOTICE","NOTICE.*","TRADEMARK*","desktop-app/src/dpslab/addon_character_identity_transport.py","desktop-app/src/dpslab/druid_role_context.py","desktop-app/src/dpslab/druid_identity_context.py","desktop-app/src/dpslab/static_template_catalog.py","desktop-app/src/dpslab/knowledge_envelope.py"],"allow_deletions":false,"allow_renames":false},
  "tests":{"focused":{"working_directory":"desktop-app","argv":["python","-m","unittest","tests.test_druid_guidance_coordinator","-v"],"environment":{"PYTHONPATH":"src","PYTHONDONTWRITEBYTECODE":"1"}},"full":{"working_directory":"desktop-app","argv":["python","-m","unittest","discover","-s","tests","-v"],"environment":{"PYTHONPATH":"src","PYTHONDONTWRITEBYTECODE":"1"}},"baseline_test_count":1216,"minimum_test_count":1226},
...
## Published implementation record — Local character context profile core 0.1
...
The authorization above was consumed only by the audited implementation in
`desktop-app/src/dpslab/local_character_context_profile.py`, its synthetic
tests, and this record. The implementation was committed as
`dde7f932bdad38792f692562b850367a20e37c4e` (`feat: add protected local
character context profile`) and published to `main`. GitHub Actions run
`33591023267` completed successfully. The reported evidence was five focused
tests and 1,241 full-suite tests passing (one expected skip), with no
SimulationCraft invocation. This closes the implementation contract; it does
...
{
  "contract_version":"0.1",
  "task_id":"addon_profile_manual_transfer_design_0_1",
  "title":"Design a consented manual transfer from addon observation to the protected local profile",
  "baseline_commit":"dde7f932bdad38792f692562b850367a20e37c4e",
  "authorization":{"status":"design_only","authorization_id":"addon_profile_manual_transfer_design_0_1-20260902-daniel","authorized_by":"Daniel","authorized_at":"2026-09-02T00:00:00-05:00"},
  "scope":{"allowed_paths":["docs/NEXT_TASK.md"],"generated_paths":[],"forbidden_paths":[".github/**","addon/**","desktop-app/**","knowledge/**","security/**","tools/**","profiles/**","scenarios/**","variants/**","comparisons/**","results/**","config/**","flasil.simc","AGENTS.md","SECURITY.md","LICENSE","LICENSE.*","NOTICE","NOTICE.*","TRADEMARK*","docs/ADDON_REAL_OBSERVATION.md","docs/DESKTOP_INTERFACE_ARCHITECTURE.md"],"allow_deletions":false,"allow_renames":false},
  "tests":{"focused":{"working_directory":".","argv":["python","-m","unittest","tools.tests.test_github_automation","-v"],"environment":{"PYTHONDONTWRITEBYTECODE":"1"}},"full":{"working_directory":".","argv":["python","-m","unittest","discover","-s","tools/tests","-v"],"environment":{"PYTHONDONTWRITEBYTECODE":"1"}},"baseline_test_count":142,"minimum_test_count":142},
  ...
  "audit":{"required":true,"independence":"declared_and_procedural"},
  "acceptance_criteria":["define a user-visible request-and-confirm sequence with no automatic import watcher, polling, login capture, addon-load capture, specialization-change capture, or background refresh","separate untrusted addon observation transport from the desktop profile input and declare strict schema, bounded field, source, freshness, compatibility, and consent checks before any future durable write","retain only the minimal core profile fields already designed and mark equipment, talents, items, combat events, account identifiers, GUIDs, raw SavedVariables, raw payloads, and unsupported API values as excluded or separately governed categories","define explicit fail-closed outcomes for missing consent, malformed or duplicate fields, stale or incompatible builds, ambiguous specialization or role, unsupported product branch, cross-profile confusion, and any attempted network transmission","require local-only, user-initiated inspect-before-create or replace behavior and a clear explanation that a valid profile does not itself produce guidance","propose synthetic-only fixtures, negative tests, exact future implementation routes, and a separate authorization boundary for any addon API, real observation, UI, persistence wiring, or recommendation work","make no implementation, capture, transfer, recommendation, catalog, UI, commit, push, or SimulationCraft change"],
...
1. What exact, closed, synthetic transport schema can represent only the core
   profile fields without preserving raw SavedVariables or an account identity?
2. Which user-visible confirmations must occur in the addon and desktop before
   an observation can be previewed, created, or replace the selected profile?
3. How should source build, interface version, product branch, capture time,
   class, specialization, and role be validated independently before a future
   profile operation becomes available?
4. Which bounded local diagnostic states can explain rejection without exposing
   a name, realm, raw payload, ciphertext, local path, or sensitive values in
   logs, errors, Git, CI, Issues, or artifacts?
5. Which synthetic fixtures and negative tests prove consent absence,
   malformed/duplicate transport fields, stale data, unsupported compatibility,
   cross-profile substitution, and attempted network use fail closed?

The required output is a design-only record in this file. Its next possible
implementation must be a separate, closed contract; no result of this design
authorizes an addon API, a real observation, a durable import, or guidance.

### Design output — consented local transfer boundary

The transfer is a two-step, local-only ceremony rather than an integration
pipe. First, the player explicitly requests a future addon export and sees
which field categories are offered. Second, the desktop application requires a
separate explicit import request, presents a bounded preview, and requires the
...
booleans, an explicit UTC timestamp representation, and duplicate-key
rejection. The desktop validates product branch, interface/build syntax,
capture freshness, class-specialization-role mapping, field category consent,
and compatibility before it can construct a profile-core input. A valid
transport is only a preview candidate: it never identifies an account, selects
...
artifacts. Any unknown, contradictory, future-schema, stale, incompatible, or
cross-profile state is non-actionable and must leave the selected profile
unchanged.

There is no network request, telemetry, cloud backup, clipboard watcher,
filesystem watcher, addon-load detection, login detection, automatic polling,
automatic refresh, background migration, or automatic export/import. A future
user may explicitly inspect the resulting protected profile and may use its
...
retention attempt; cross-profile substitution; failed protected-store write;
...
## Consumed implementation authorization — Núcleo de sesión local de análisis 0.1
...
`17ed52710bed036ee516dec82a3782f4348ad207` (`feat: add bounded local
analysis session core`). Local and remote verification confirmed that
`main` and `origin/main` point to that commit. GitHub Actions run
`33836971408` passed Static analysis and secret scanning, Policy and contract,
Functional suite, and Tools tests. This closure does not authorize a source
...
application later accepts only a manually pasted copy. This is deliberately
...
{
  "contract_version":"0.1",
  "task_id":"live_manual_analysis_export_design_0_1",
  "title":"Design the live manual addon-to-desktop analysis export",
  "baseline_commit":"17ed52710bed036ee516dec82a3782f4348ad207",
  "authorization":{"status":"design_only","authorization_id":"live_manual_analysis_export_design_0_1-20260903-daniel","authorized_by":"Daniel","authorized_at":"2026-09-03T00:00:00-05:00"},
  "scope":{"allowed_paths":["docs/NEXT_TASK.md"],"generated_paths":[".dpslab/quality-gates/live_manual_analysis_export_design_0_1/design.json"],"forbidden_paths":[".github/**","addon/**","desktop-app/**","knowledge/**","security/**","tools/**","profiles/**","scenarios/**","variants/**","comparisons/**","results/**","config/**","flasil.simc","AGENTS.md","SECURITY.md","LICENSE","LICENSE.*","NOTICE","NOTICE.*","TRADEMARK*","docs/ADDON_OBSERVATION_TRANSPORT.md","docs/ADDON_REAL_OBSERVATION.md","docs/DESKTOP_INTERFACE_ARCHITECTURE.md"],"allow_deletions":false,"allow_renames":false},
  "tests":{"focused":{"working_directory":".","argv":["python","-m","unittest","tools.tests.test_github_automation","-v"],"environment":{"PYTHONDONTWRITEBYTECODE":"1"}},"full":{"working_directory":".","argv":["python","-m","unittest","discover","-s","tools/tests","-v"],"environment":{"PYTHONDONTWRITEBYTECODE":"1"}},"baseline_test_count":142,"minimum_test_count":142},
...
The player remains in control of every transfer. A future addon command may
render one copyable, player-selectable text payload for the current character;
it must not emit the payload through chat, automatically access the clipboard,
or split a partial payload across messages. A plain export
contains only equipped observations; the optional form takes one explicitly
chosen bag as its candidate source. Selecting that bag is a request for a
bounded candidate list, not permission to inspect every bag, retain a bag
...
classification, duplicate item/slot identity, noncanonical structure, excess
items, incomplete modifier fields, or an attempt to mark a candidate as
current-expansion solely from the export.
...
The next implementation proposal, if later authorized, is limited to:

- `addon/DpsLab/CharacterEquipmentObservation.lua`;
- `addon/DpsLab/DpsLab.lua` and `addon/DpsLab/DpsLab.toc`;
- `desktop-app/src/dpslab/addon_live_analysis_transport.py`;
- `desktop-app/tests/test_addon_live_analysis_transport.py`;
- `tools/tests/test_addon_live_analysis_export.py`;
- `docs/ADDON_LIVE_ANALYSIS_EXPORT.md`; and
- `docs/NEXT_TASK.md`.

It must be split from any desktop UI, local retention, current-content catalog,
...
{
  "contract_version":"0.1",
  "task_id":"training_dummy_session_capture_design_0_1",
  "title":"Design voluntary bounded training-dummy practice capture",
  "baseline_commit":"ac8b883ec89936ed356b57c6f7f109dc9e208de5",
  "authorization":{"status":"design_only","authorization_id":"training_dummy_session_capture_design_0_1-20260904-daniel","authorized_by":"Daniel","authorized_at":"2026-09-04T00:00:00-05:00"},
  "scope":{"allowed_paths":["docs/NEXT_TASK.md"],"generated_paths":[".dpslab/quality-gates/training_dummy_session_capture_design_0_1/design.json"],"forbidden_paths":[".github/**","addon/**","desktop-app/**","knowledge/**","security/**","tools/**","profiles/**","scenarios/**","variants/**","comparisons/**","results/**","config/**","flasil.simc","AGENTS.md","SECURITY.md"],"allow_deletions":false,"allow_renames":false},
  "protected_files":{".github/workflows/dpslab-ci.yml":"17677d962db150a8ecbe043da31d353428fe85afc00bc4e46cc60a2719b88348","AGENTS.md":"c15c97baba056911b5838c55af45f8e2053bb1c51ab3fc3033b89a99b9cdc6d7","SECURITY.md":"b00e680630009bfd062a58b5a8d3129b9c68e45fb8aa284f05133f173fe2daf5","security/security_baseline_0_1.json":"a052db44ed119988fe5e40d244cd08e0f346ffcbe2dc1a7098488af88be88b6b"},
  "audit":{"required":true,"independence":"declared_and_procedural"},
...
## Historical design authorization — Advisor guidance contract 0.1
...
## Historical implementation authorization — Advisor synthetic guidance package 0.1

<!-- DPSLAB_HISTORICAL_TASK_CONTRACT_BEGIN -->
```json
{"contract_version":"0.1","task_id":"advisor_synthetic_guidance_package_0_1","title":"Implement non-actionable synthetic Advisor guidance package","baseline_commit":"5c7311e47bbaa98143fbe3bbfae38bfe429a9ecc","authorization":{"status":"authorized_for_implementation","authorization_id":"advisor_synthetic_guidance_package_0_1-20260904-daniel","authorized_by":"Daniel","authorized_at":"2026-09-04T00:00:00-05:00"},"scope":{"allowed_paths":["addon/DpsLab/AdvisorSyntheticGuidance.lua","addon/DpsLab/DpsLab.lua","addon/DpsLab/DpsLab.toc","desktop-app/src/dpslab/advisor_guidance_package.py","desktop-app/tests/test_advisor_guidance_package.py","tools/tests/test_advisor_synthetic_guidance.py","docs/ADVISOR_GUIDANCE_PACKAGE.md","docs/NEXT_TASK.md"],"generated_paths":[".dpslab/quality-gates/advisor_synthetic_guidance_package_0_1/implementation.json",".dpslab/quality-gates/advisor_synthetic_guidance_package_0_1/audit.json"],"forbidden_paths":[".github/**","knowledge/**","security/**","profiles/**","scenarios/**","variants/**","comparisons/**","results/**","config/**","flasil.simc","AGENTS.md","SECURITY.md"],"allow_deletions":false,"allow_renames":false},"tests":{"focused":{"working_directory":"desktop-app","argv":["python","-m","unittest","tests.test_advisor_guidance_package","-v"],"environment":{"PYTHONPATH":"src","PYTHONDONTWRITEBYTECODE":"1"}},"full":{"working_directory":"desktop-app","argv":["python","-m","unittest","discover","-s","tests","-v"],"environment":{"PYTHONPATH":"src","PYTHONDONTWRITEBYTECODE":"1"}},"baseline_test_count":1274,"minimum_test_count":1278},"protected_files":{".github/workflows/dpslab-ci.yml":"17677d962db150a8ecbe043da31d353428fe85afc00bc4e46cc60a2719b88348","AGENTS.md":"c15c97baba056911b5838c55af45f8e2053bb1c51ab3fc3033b89a99b9cdc6d7","SECURITY.md":"b00e680630009bfd062a58b5a8d3129b9c68e45fb8aa284f05133f173fe2daf5","security/security_baseline_0_1.json":"a052db44ed119988fe5e40d244cd08e0f346ffcbe2dc1a7098488af88be88b6b"},"audit":{"required":true,"independence":"declared_and_procedural"},"acceptance_criteria":["implement one closed synthetic package with generic statistic targets gear-priority labels and priority-display labels for damage tank and healer","require a synthetic marker and reject all personalized current-content or actionable claims","enforce tank survival-first and healer healing-safety-first ordering in the package validator","make addon rendering explicitly synthetic and non-actionable without event registration timers network persistence inventory enumeration or ability automation","parse only canonical bounded text in the desktop module and return immutable summaries","pass focused full functional and tools suites quality gate and protected-hash checks without SimulationCraft"],"express_exclusions":["real guidance data, real sources, real character or practice data, live WoW APIs, current-content catalog mutation, UI overlays, persistence, network, telemetry, inventory enumeration, recommendation execution, simulation engine, SimulationCraft, commit, push, release, or paths outside the allowlist"]}
```
<!-- DPSLAB_HISTORICAL_TASK_CONTRACT_END -->

## Historical design authorization — Druid current-template evidence boundary 0.1

<!-- DPSLAB_HISTORICAL_TASK_CONTRACT_BEGIN -->
```json
{"contract_version":"0.1","task_id":"druid_current_template_evidence_design_0_1","title":"Define the evidence boundary before a current Druid template can be considered","baseline_commit":"39c31ac7f3dfb3fca002968724fc2a56b25e0171","authorization":{"status":"design_only","authorization_id":"druid_current_template_evidence_design_0_1-20260905-daniel-continuation","authorized_by":"Daniel","authorized_at":"2026-09-05T00:00:00-05:00"},"scope":{"allowed_paths":["docs/DRUID_VERTICAL_SLICE.md","docs/NEXT_TASK.md"],"generated_paths":[".dpslab/quality-gates/druid_current_template_evidence_design_0_1/design.json"],"forbidden_paths":[".github/**","addon/**","desktop-app/**","knowledge/**","security/**","tools/**","profiles/**","scenarios/**","variants/**","comparisons/**","results/**","config/**","flasil.simc","AGENTS.md","SECURITY.md"],"allow_deletions":false,"allow_renames":false},"tests":{"focused":{"working_directory":"desktop-app","argv":["python","-m","unittest","tests.test_druid_guidance_coordinator","-v"],"environment":{"PYTHONPATH":"src","PYTHONDONTWRITEBYTECODE":"1"}},"full":{"working_directory":".","argv":["python","-m","unittest","discover","-s","tools/tests","-v"],"environment":{"PYTHONDONTWRITEBYTECODE":"1"}}},"audit":{"required":true,"independence":"declared_and_procedural"},"acceptance_criteria":["define the minimum reviewed evidence bindings needed before a Druid template may claim current applicability","preserve primary-source authority and fansite corroboration only","preserve role safety ordering and fail-closed unavailable outcomes","name future synthetic-only implementation boundaries without adding game facts or product functionality"],"express_exclusions":["real source acquisition or retention","current game facts specialization IDs spells rotations talents items statistics coefficients or balance claims","catalog mutation","addon desktop or UI code","live observation persistence network telemetry simulation SimulationCraft","commit push release or any path outside the allowlist"]}
```
<!-- DPSLAB_HISTORICAL_TASK_CONTRACT_END -->

## Historical implementation authorization — Druid current-template evidence 0.1

<!-- DPSLAB_HISTORICAL_TASK_CONTRACT_BEGIN -->
```json
{"contract_version":"0.1","task_id":"druid_current_template_evidence_0_1","title":"Implement synthetic Druid current-template evidence validation","baseline_commit":"4180fe23605648756b2d63a7be6fe58b14e92c90","authorization":{"status":"authorized_for_implementation","authorization_id":"druid_current_template_evidence_0_1-20260905-daniel-continuation","authorized_by":"Daniel","authorized_at":"2026-09-05T00:00:00-05:00"},"scope":{"allowed_paths":["desktop-app/src/dpslab/druid_current_template_evidence.py","desktop-app/tests/test_druid_current_template_evidence.py","docs/DRUID_CURRENT_TEMPLATE_EVIDENCE.md","docs/NEXT_TASK.md"],"generated_paths":[".dpslab/quality-gates/druid_current_template_evidence_0_1/implementation.json",".dpslab/quality-gates/druid_current_template_evidence_0_1/audit.json"],"forbidden_paths":[".github/**","addon/**","knowledge/**","security/**","tools/**","profiles/**","scenarios/**","variants/**","comparisons/**","results/**","config/**","flasil.simc","AGENTS.md","SECURITY.md"],"allow_deletions":false,"allow_renames":false},"tests":{"focused":{"working_directory":"desktop-app","argv":["python","-m","unittest","tests.test_druid_current_template_evidence","-v"],"environment":{"PYTHONPATH":"src","PYTHONDONTWRITEBYTECODE":"1"}},"full":{"working_directory":"desktop-app","argv":["python","-m","unittest","discover","-s","tests","-v"],"environment":{"PYTHONPATH":"src","PYTHONDONTWRITEBYTECODE":"1"}},"baseline_test_count":1281,"minimum_test_count":1286},"protected_files":{".github/workflows/dpslab-ci.yml":"17677d962db150a8ecbe043da31d353428fe85afc00bc4e46cc60a2719b88348","AGENTS.md":"c15c97baba056911b5838c55af45f8e2053bb1c51ab3fc3033b89a99b9cdc6d7","SECURITY.md":"b00e680630009bfd062a58b5a8d3129b9c68e45fb8aa284f05133f173fe2daf5","security/security_baseline_0_1.json":"a052db44ed119988fe5e40d244cd08e0f346ffcbe2dc1a7098488af88be88b6b"},"audit":{"required":true,"independence":"declared_and_procedural"},"acceptance_criteria":["accept only a closed synthetic evidence record with four independent bindings: attended registry receipt, reviewed semantic mapping, reviewed primary-source applicability receipt, and role-safe closed template receipt","retain only bounded synthetic identifiers hashes compatibility ranges review states and unavailable reasons; never retain source text URLs page content display names current game facts or character identifiers","require exact Druid role-policy agreement and tank/healer safety-first ordering before returning review_eligible","reject absent stale malformed conflicting unreviewed non-synthetic or incompatible evidence as bounded unavailable outcomes","return immutable decisions and preserve all caller inputs","pass focused full functional and tools suites quality gate and protected-hash verification without SimulationCraft"],"express_exclusions":["real source acquisition or retention","current game facts specialization IDs spells rotations talents items statistics coefficients or balance claims","catalog mutation","addon desktop UI code outside the allowlist","live observation persistence network telemetry simulation SimulationCraft","commit push release or any path outside the allowlist"]}
```
<!-- DPSLAB_HISTORICAL_TASK_CONTRACT_END -->
...
```json
{"contract_version":"0.1","task_id":"balance_multiloadout_delivery_plan_0_1","title":"Prepare full Balance multiloadout delivery for Terra or Luna","baseline_commit":"0897bbc0077938848846512401f278884ba3bab4","authorization":{"status":"design_only","authorization_id":"daniel-session-multiloadout-plan","authorized_by":"Daniel","authorized_at":"2026-09-09T00:00:00-05:00"},"scope":{"allowed_paths":["docs/NEXT_TASK.md","docs/BALANCE_MULTILOADOUT_HANDOFF.md"],"generated_paths":[".dpslab/quality-gates/balance_multiloadout_delivery_plan_0_1/design.json"],"forbidden_paths":["AGENTS.md","SCOPE_CORRECTION_0_1.md","desktop-app/**","addon/**","installer/**","profiles/**","results/**",".github/**"],"allow_deletions":false,"allow_renames":false},"tests":{"focused":{"working_directory":"desktop-app","argv":["python","-m","unittest","tests.test_druid_guidance_coordinator","-v"],"environment":{"PYTHONPATH":"src","PYTHONDONTWRITEBYTECODE":"1"}},"full":{"working_directory":"desktop-app","argv":["python","-m","unittest","discover","-s","tests","-v"],"environment":{"PYTHONPATH":"src","PYTHONDONTWRITEBYTECODE":"1"}},"baseline_test_count":1287,"minimum_test_count":1288},"protected_files":{"AGENTS.md":"d1b67f089fb267ef94390588785e892a1f1bdc6e84bdb6f3ccf0840813ad1495","SCOPE_CORRECTION_0_1.md":"3751ad5864ceb62cad2c82a8d4a0f2c384be1e0c0aa555d8a5eb3092d00f8bbf"},"audit":{"required":true,"independence":"declared_and_procedural"},"acceptance_criteria":["Record current protected SHA-256 values without changing Daniel's documents","Prepare a single-executor handoff covering every current Scope section 1 outcome","Commit and push approved work and planning; preserve main and real user installations"],"express_exclusions":["Implementation or agent activation during planning","Real SimulationCraft execution, deployment, merge or release","Unrelated dirty main checkout work"]}
```
...
loadouts de Restauración, la app ejecuta ambas simulaciones y escribe un
resultado breve para el addon. Se tocaron `addon/DpsLab/`,
`desktop-app/src/dpslab/`, sus pruebas focales y este registro. La prueba de
